    ...
    return(
        <article className="w-full flex items-center justify-between relative rounded-br-2xl rounded-3xl border border-solid border-dark bg-light shadow-2xl p-12 dark:bg-dark dark:border-light lg:flex-col lg:p-8 xs:rounded-2xl xs:rounded-br-3xl xs:p-4">
            ...
            <div className="w-1/2 flex flex-col items-start justify-between pl-6 lg:w-full lg:pl-0 lg:pt-6">
                ...
                <div className="mt-2 flex items-center">
                    <Link href={github} target="_blank" className="w-9 md:w-8"> <GithubIcon /></Link>
                    <Link href={link} target="_blank" className="ml-4 rounded-lg bg-dark text-light p-2 px-6 text-lg font-semibold dark:bg-light dark:text-dark sm:px-4 sm:text-base">Visit Project</Link>
  ...
  <link rel="manifest" href="/images/favicon/site.webmanifest" />
    ...
    />
                    ...
                    <div className="col-span-12">
                            ...
                            img={project2}
                            summary="This system leverages IoT technology to provide early fire detection and real-time alerts without the need for internet connectivity. Utilizing an Arduino Uno, SIM900A GSM module, and fire sensors, it sends SMS and automated calls to designated responders when a fire is detected. Designed for affordability and reliability, the system is suitable for remote areas and varied settings like homes, offices, warehouses, and agricultural zones. Its standalone, GSM-based approach ensures rapid response, reducing fire-related damage and enhancing safety.
                                         Expandable with additional sensors, it offers a scalable, low-maintenance solution for modern fire alerting needs."
                        ...
                        <Project 
                            ...
                            This solution modernizes print services, ensuring efficiency, scalability, and enhanced user experience."
